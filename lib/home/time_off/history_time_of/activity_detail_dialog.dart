    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text('Descriptions:', style: AppTextStyles.heading2_1),
            Text('${activity['private_name'] ?? '-'}',
            ...
            Text('Create Date: ${formatDate(activity['create_date'])}',
                style: AppTextStyles.heading3),
            Text('Duration:', style: AppTextStyles.heading2_1),
            Text('${activity['duration_display'] ?? '-'}',
                style: AppTextStyles.heading3),
            Text('Status: ', style: AppTextStyles.heading2_1),
